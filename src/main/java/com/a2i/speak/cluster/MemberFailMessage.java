 ...
 * @author atrimble
 */
public class MemberFailMessage extends AbstractRPCMessage {

    private final MessagePack msgPack = new MessagePack();

    private static final Logger LOG = LoggerFactory.getLogger(MemberFailMessage.class);
    ...
    private final String filter = "member-failed";
    ...
    @Override
    public MemberFailMessage decode(byte[] bytes) throws IOException {
