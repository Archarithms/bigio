 ...
 * @author atrimble
 */
public class MemberJoinMessage extends AbstractRPCMessage {

    private final MessagePack msgPack = new MessagePack();

    private static final Logger LOG = LoggerFactory.getLogger(MemberJoinMessage.class);
    ...
    private final String filter = "member-join";
    ...
    @Override
    public MemberJoinMessage decode(byte[] bytes) throws IOException {
